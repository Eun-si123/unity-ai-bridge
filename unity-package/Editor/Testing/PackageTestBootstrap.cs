...
namespace UnityAiBridge.Editor.Testing
{
    ...
    internal static class PackageTestBootstrap
    {
        ...
        {
            EditorApplication.delayCall += TryAutoEnablePackageTests;
        }
        ...
        private static void TryAutoEnablePackageTests()
        {
            try
            {
                ...
                {
                    // Unity treats embedded packages as development packages and exposes their tests
                    // without requiring a project-manifest testables entry.
                    return;
                }
        ...
        private static void EnsurePackageTestsEnabled(bool logSuccess)
        {
            ...
            {
                Debug.Log(
                    "[Unity AI Bridge] Enabled package tests in Packages/manifest.json. " +
                    "After Package Manager resolves and scripts compile, the EditMode tests should appear in Test Runner.");
            }
        }
    }
