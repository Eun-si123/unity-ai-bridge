...
Example request/result fixtures live in `fixtures/editor-status.*`, `fixtures/hierarchy.*`, `fixtures/object-resolve.*`, `fixtures/gameobject-create.*`, `fixtures/scene-save.*`, and `fixtures/diagnostics.*`.
