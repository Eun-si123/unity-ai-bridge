...
This directory contains the first source-defined Unity-facing bridge contract.
...
Version `0` is pre-stable. Breaking changes are allowed while Phase 0/1 is under development, but changes must update schemas, TypeScript/C# protocol constants, fixtures, tests, and project status documentation together.
...
The schema does not depend on WebSocket. WebSocket is the first planned Unity transport implementation.
